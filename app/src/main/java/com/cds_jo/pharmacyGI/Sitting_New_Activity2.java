...
public class Sitting_New_Activity2 extends FragmentActivity
{
  ...
  private Context context;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sitting_new2);
...
/*
		...
		alertDialog.setPositiveButton("نعم", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {*/
				String q;
				SqlHandler sqlHandler = new SqlHandler(Sitting_New_Activity2.this);
			...
			//	et_Sal_inv.setText("0");
				...
				SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(Sitting_New_Activity2.this);
				SharedPreferences.Editor editor = sharedPreferences.edit();
				...
				AlertDialog alertDialog = new AlertDialog.Builder(
						Sitting_New_Activity2.this).create();
