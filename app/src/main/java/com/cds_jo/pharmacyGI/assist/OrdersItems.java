...
import com.cds_jo.pharmacyGI.NewLoginActivity;
...
public class OrdersItems extends FragmentActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orders_items_n);
...
//            tv_LocationNm.setVisibility(View.INVISIBLE);
...
//        }
      ...
      /*  lv_Items.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent k = new Intent(OrdersItems.this, MasterActivity.class);
                startActivity(k);
            }
        });
*/
        ...
        //btn_EnterNotes=(Button) findViewById(R.id.btn_EnterNotes);
