...
public class Select_Man extends DialogFragment implements View.OnClickListener  {
    View form ;
    Button add,cancel;
    ListView items_Lsit;
    TextView itemnm;
    ...
    public View onCreateView( final LayoutInflater inflater   , ViewGroup container  ,Bundle savestate) {
        ...
        form = inflater.inflate(R.layout.activity_select__man, container, false);
        ...
        items_Lsit.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                if (getArguments().getString("Scr") == "CountrySales") {
                    ((CountrySales) getActivity()).SetMan(mans.getAcc(), mans.getNm());

                }
                else if (getArguments().getString("Scr") == "ManVisitReport") {
                    ((ManVisitReport) getActivity()).SetMan(mans.getAcc(), mans.getNm());
                }
    ...
    public void onProgressUpdate(String t ){
        ...
        if (t.toString().equals("")){
              query = "Select   * from manf  ";//   Customers.Cust_type='"+Cust_type+"'";
        }
        else {
            query = "Select * from manf where name like '%" + t + "%' or  no like '%" + t + "%'";//  And Customers.Cust_type='"+Cust_type+"'";
        }
        ...
        if (c!=null && c.getCount()!=0 ){
            if(c.moveToFirst()){
             do{
                 ...
                 mans.setNo(c.getString(c.getColumnIndex("man")));
                 mans.setAcc(c.getString(c.getColumnIndex("man")));
