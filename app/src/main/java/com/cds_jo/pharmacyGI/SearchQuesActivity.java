...
public class SearchQuesActivity extends DialogFragment implements View.OnClickListener  {
    View form ;
    Button add,cancel;
    ListView items_Lsit;
  //  TextView itemnm;
    ...
    public View onCreateView( final LayoutInflater inflater   , ViewGroup container  ,Bundle savestate){
        ...
        form =inflater.inflate(R.layout.activity_quest_po,container,false);


         items_Lsit=(ListView) form.findViewById(R.id.listView2);
        ArrayList<cls_Search_po> cls_search_pos_list  = new ArrayList<cls_Search_po>();
        cls_search_pos_list.clear();
        String q = "Select distinct po.Orderno,po.date    ,IFNULL( c.name ,'') as name , po.acc from QuesHdr po Left join" +
                " Customers c on c.no = po.acc ";
        ...
        items_Lsit.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
              ...
              //  Toast.makeText(getActivity(), nm, Toast.LENGTH_LONG).show();
                ...
                ((QuestneerActivity)getActivity()).Set_Order(po_obj.getCustNo(), po_obj.getCustNm(),po_obj.getAcc());
                 Exist_Pop();
