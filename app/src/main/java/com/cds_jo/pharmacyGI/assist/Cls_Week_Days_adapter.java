 ...
 */
public class Cls_Week_Days_adapter extends BaseAdapter {

    Context context;
    ArrayList<Cls_WeekDays> cls_search_pos;

    public Cls_Week_Days_adapter(Context context, ArrayList<Cls_WeekDays> list) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.week_days_rows, null);
