 ...
 */
public class cls_SearchCust_Qty_adapter extends BaseAdapter {

    Context context;
    ArrayList<cls_Search_po> cls_search_pos;

    public cls_SearchCust_Qty_adapter(Context context, ArrayList<cls_Search_po> list) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.cust_qty_row_search, null);
